...
const Features = () => {
    const features = [
        ...
        },
        {
            ...
            description: "Collect payments in Naira or Solana with ease. Fast confirmation, zero confusion, and fully automated tracking.",
            ...
            >
                {features.map((feature, index) => {
                    ...
                    return (
                        <motion.div
                            key={index}
                            className={`bg-linear-to-br ${feature.gradient} backdrop-blur-sm p-8 rounded-2xl border border-gray-200/50 flex flex-col gap-4 hover:shadow-xl hover:scale-[1.02] transition-all duration-300 relative overflow-hidden`}
